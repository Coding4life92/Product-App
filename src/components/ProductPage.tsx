...
const ProductPage = () => {
    ...
    return (
        <div className="p-5 w-[60%]">
            <button onClick={() => navigate(-1)} className="mb-3 px-4 py-2 bg-black text-white rounde cursor-pointer">Back</button>
            ...
            <div className="flex">
                ...
                <p className="ml-10">Rating: {product.rating}</p> <StarIcon className="text-yellow-500 ml-2" />
            </div>
